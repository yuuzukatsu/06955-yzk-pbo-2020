...
public class CaseGangguanEntity {
    ...
    private CaseGangguanEntity ggn;
    private int Dimas06955_NoCase,Dimas06955_IdPelanggan,Dimas06955_IdHelpdesk;
    private Date Dimas06955_Tanggal;
    private String Dimas06955_Komplain;
    ...
    public CaseGangguanEntity getGGN(){
        return ggn;
    }
